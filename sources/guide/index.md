...
![pic](https://upyun-assets.b0.upaiyun.com/docs/guide/pic.jpg!600)
...
> **注：**    
> 编码方式（字符集）：统一使用 UTF-8 。   
> 连接方式：选择普通不加密的 FTP 连接方式，不要选择 TLS 等加密类型连接 FTP 。    
> 在一些 FTP 工具的主机栏中，你可以输入 `ftp://v0.ftp.upyun.com` ,这样能够根据协议自动识别连接方式。    

![](http://techs.b0.upaiyun.com/img/ftp.png!600)
