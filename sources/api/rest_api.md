...
| x-upyun-meta-ttl 	| 否   	| String  	| 文件元信息, 指定文件的生存时间， 单位天，见 [Metadata](/api/rest_api/#metadata)           |
...
| x-upyun-meta-ttl      | 否   	| String  	| 文件元信息, 指定文件的生存时间， 单位天，详见 [Metadata](/api/rest_api/#metadata)   |
